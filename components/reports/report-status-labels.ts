...
export const GATE1_LABEL = {
  ...
  CONFLICT_HEADING: "The documents show different information",
  CONFLICT_SUBHEADING: "Choose the value this report should use.",
  CONFLICT_ENTER_OTHER: "Enter another figure",
  CONFLICT_ENTER_OTHER_PROMPT: "Enter the exact value",
  CONFLICT_ENTER_TITLE: "Enter the correct value",
  CONFLICT_ENTER_HELPER: "Review the source and enter the exact value the report should use.",
  CONFLICT_AMBIGUOUS_HINT: "This source mentions a value that isn't specific enough to use.",
  CONFLICT_AMBIGUOUS_LABEL: "This source does not give a clear value",
